...
let compare = "https://myanimelist.net/animelist/"
let compare2 = "http://myanimelist.net/animelist/"

if(pageUrl.substring(0,34) != compare || pageUrl.substring(0,33) != compare2 ){
            defineTheme();
}
function defineTheme(){
    ...
    PageStyles.innerHTML += ` .forum-board-description{color:#fff }`;
    PageStyles.innerHTML += ` .synopsis{color:#fff !important} `;
    PageStyles.innerHTML += ` .forum-board{background-color:${preto} !important}`;
    PageStyles.innerHTML += ` .btn-rect-grey1{color:${preto} !important}`;
    PageStyles.innerHTML += ` .btn-rect-grey1 a{color:${preto} !important}`;
    ...
    PageStyles.innerHTML += ` .pt4{color:#fff !important }`;
    PageStyles.innerHTML += ` .informantion{color:#fff !important }`;
    PageStyles.innerHTML += ` .ac{color:#fff !important }`;
    PageStyles.innerHTML += ` .btn-club-join{color:${preto} !important}`;
    ...
    PageStyles.innerHTML += `  #content{color:#fff !important}`;
    PageStyles.innerHTML += ` .normal_header{color:#fff !important}`;
    PageStyles.innerHTML += ` .clearfix{background-color:${preto} !important}`;
    PageStyles.innerHTML += ` .icon-user-function{background-color:${preto} !important}`;
    PageStyles.innerHTML += ` .lightLink{color:#fff !important}`;
    PageStyles.innerHTML += ` .dark_text{color:#fff !important}`;
    PageStyles.innerHTML += ` .user-status li{background-color:${preto} !important}`;
